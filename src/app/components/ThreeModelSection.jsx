  ...
  return (
    <section className="relative w-full h-[500vh] bg-white">
      ...
      <div className="fixed top-6 right-6 z-50 w-[300px] text-right break-words pr-4">
        <PriceList visible={scrollY >= 2000 && scrollY < 3000} />
        <TextPhaseOne visible={scrollY >= 1200 && scrollY < 2000} />
        <TextPhaseTwo visible={scrollY >= 2000 && scrollY < 3000} />
        <TextPhaseThree visible={scrollY >= 3000 && scrollY < 4000} />
      </div>
    </section>
  )
}
